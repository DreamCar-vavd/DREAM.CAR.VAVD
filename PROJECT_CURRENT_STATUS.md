...
Поточна контрольна точка: **`47fbfb88fc40103368dd692c02c3638f06e9d1f6`**
(squash-коміт PR #21, `fix: make the "book a consultation" link work in
the gallery project modal`, злито `2026-09-05T13:13:36Z`) — після PR #17
(легша CSS-маска логотипу), PR #18 (CTA "консультація" в модалці послуги),
PR #19 (передача обраного авто у форму), PR #20/#22 (документація) — усі
`2026-09-05`, доказ — розділ 21; PR #21 — розділ 22.
...
**Активної технічної задачі немає.** Останній завершений етап на
Production — PR #17–#21 (легша CSS-маска логотипу, CTA "консультація" в
модалці послуги, передача обраного авто у форму, виправлення такого самого
CTA в модалці галерейного проєкту, документація #20/#22), усі змерджені й
перевірені на Production `2026-09-05`. Власник підтвердив у чаті: спершу
«ПРОВІРИВ ВСЕ ТЕ ПРАЦЮЄ. 17-18-19 ПРАЦЮЄ», потім — що кнопка "Замовити
консультацію" працює на Preview PR #21 (підтвердження поведінки кнопки;
конкретний браузер не уточнено в обох випадках). Жодне з цих підтверджень
не є окремою перевіркою саме Production чи доставки листів через форму.
Повний доказ CI/deployment/production-перевірки — розділ 21 (PR #17–#20) і
розділ 22 (PR #21).
...
- **Не є регресією PR #21**, не блокувало його merge. Окремий, поза цим
  PR, кандидат для майбутнього покращення доступності (повернення фокуса
  на тригер після Escape/X/фону в `GalleryGrid.closeModal`) — не внесений
  до backlog розділу 19 автоматично, потребує окремого рішення власника.
