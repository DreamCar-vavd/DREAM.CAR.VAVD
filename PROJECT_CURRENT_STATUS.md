...
| B3 | Фото авто в продажу — пережати вихідні JPG (зараз 1+ МБ, роздільність до 5712 px) **Оновлення 21.09.2026:** аудит старих CMS-фото завершено, batch-перетворення свідомо відхилене — див. §26 і `docs/PANEL-existing-photo-optimization.md`; браузерний оптимізатор діє лише для нових завантажень | середній |
