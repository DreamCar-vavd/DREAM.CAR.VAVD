...
**Наступний окремий етап (не розпочато):** панель керування контентом —
проєкт і оцінка у зовнішньому документі
`DREAM.CAR.VAVD-mask-optimization-20260905/report/32-…`. Потребує рішень
...
- 6 карток «Галерея N» відкривають модалку з текстом-заглушкою
  ...
  залишено **без змін**.
- Панель керування контентом — окремий наступний етап, не розпочато
  (проєкт: `report/32-…` у папці результатів).
