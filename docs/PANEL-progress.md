...
- **Задача 20:24→21:20 (Б3-preview + залишки):**
  ...
  - **Блок 4 — мобільний Preview.** Обидва браузерні інструменти без
    GitHub-сесії Preview цієї сесії. Компаунд-блокер незмінний. Не-авторизовані
    375/320 — h-overflow немає. Pending, інструкція власнику в §J.
