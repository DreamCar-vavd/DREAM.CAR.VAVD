...
- **Head:** `fd1158a8e48417c9eb1dd4a57fb10bc62a07a476` (+ цей журнал наступним комітом)
- **CI `Verify`:** `2e83ece` — success · для `fd1158a` — очікується
- **Тести:** 242 pass · tsc 0 · eslint 0 · build OK · content:check/guard/export — зелені
