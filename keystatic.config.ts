      ...
      schema: {
        ...
        photos: fields.array(
          ...
          }),
          {
            label: "Фотографії",
            description:
              "Перше фото = головне (обкладинка). Порядок змінюється перетягуванням або стрілками ↑ ↓. Рекомендовано: WebP, ширина 2000–2400 px, розмір 200–800 КБ. Технічний максимум — 12 МБ на одне зображення.",
      ...
      schema: {
        ...
        photos: fields.array(
          ...
          }),
          {
            ...
            description:
              "Перше фото = обкладинка картки. Порядок — перетягуванням або стрілками ↑ ↓. Рекомендовано: WebP, ширина 2000–2400 px, розмір 200–800 КБ. Технічний максимум — 12 МБ на одне зображення.",
            itemLabel: (props) => props.fields.caption.value || "Фото",
            validation: { length: { min: 1 } },
          },
        ),
